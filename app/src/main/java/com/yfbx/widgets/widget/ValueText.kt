...
class ValueText @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    private fun getAttr(context: Context, attrs: AttributeSet?) {
        ...
        textSize = array.getDimension(R.styleable.ValueText_android_textSize, 14f.sp)
        titleSize = array.getDimension(R.styleable.ValueText_titleSize, 14f.sp)
        ...
        drawablePadding = array.getDimension(R.styleable.ValueText_android_drawablePadding, 8f.dp)
        textAlign = array.getInt(R.styleable.ValueText_textAlign, ALIGN_LEFT)
        textMargin = array.getDimension(R.styleable.ValueText_textMargin, 16f.sp)
        isSingleLine = array.getBoolean(R.styleable.ValueText_android_singleLine, false)
        lineSpace = array.getDimension(R.styleable.ValueText_lineSpace, 6f.dp)
        array.recycle()
    }
